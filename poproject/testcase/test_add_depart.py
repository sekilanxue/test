...
class TestAddDepart:
    ...
    #     self.main.goto_add_member().confire_to_contact(name,acctid,phone).get_list_member(name)
    ...
    def test_add_depart(self):
        list_depart = self.main.goto_contact().add_depart().get_list_depart()
        assert '牛哥的UI设计部' in list_depart